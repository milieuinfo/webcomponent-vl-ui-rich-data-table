...
export class VlRichDataTable extends VlElement(HTMLElement) {
    ...
    __observeFilterButtons() {
        ...
        this.__filterToggleButton.addEventListener('click', () => {
            ...
            this.__filter.querySelectorAll('[data-vl-hidden-in-modal]').forEach(element => element.hidden = false);
        ...
        this.__filterOpenButton.addEventListener('click', () => {
            ...
            this.__filter.querySelectorAll('[data-vl-hidden-in-modal]').forEach(element => element.hidden = true);
