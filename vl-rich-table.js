...
function renderFilter(dataTable) {
  return `
        <style>
...
function whenFilterActivated(doWithSearchCriteria) {
  return filter => {
    let filterRoot;
...
export { RenderFunctions, SortDirections, VlRichTable, VlRichTableField, VlRichTablePager, asc, desc, renderFilter, whenFilterActivated };
